...
Check if a tree is balanced or not ---remain
Diagnol Traversal of a Binary tree
Boundary traversal of a Binary tree -- some improvement is required
Construct Binary Tree from String with Bracket Representation 
Convert Binary tree into Doubly Linked List --- array us and print data 
Convert Binary tree into Sum tree --ok 
Construct Binary tree from Inorder and preorder traversal
Find minimum swaps required to convert a Binary tree into BST
Check if Binary tree is Sum tree or not
Check if all leaf nodes are at same level or not
Check if a Binary Tree contains duplicate subtrees of size 2 or more [ IMP ]
Check if 2 trees are mirror or cot
