...
public class Find_maximum_sub_array_main {

	static void maxSubArraySum(List<Integer> l, int size) {
		int max = Integer.MIN_VALUE, cur = 0, st = 0, Lt= 0, s = 0;
...
//		System.out.println("Ending index " + Lt);
	}
...
//		maxSubArraySum(a, n);
	 ...
	 public static ArrayList<Integer> plusOne(ArrayList<Integer> A) {
		  ...
		  ArrayList<Integer> arr = new ArrayList<Integer>();
	        int total = 0; String sno = "";
	        for(int i =0; i<A.size();i++){
	            sno += A.get(i) +"";
	        }
	        Integer val = Integer.parseInt(sno);
	        val = val +1;
	        String rno = String.valueOf(val);

	        for(int i = 0 ; i<A.size();i++){
//	        	int n = Integer.valueOf(rno.charAt(i)+"");
	      
	        	
	            arr.add( Integer.valueOf(rno.charAt(i)+""));
	        }
