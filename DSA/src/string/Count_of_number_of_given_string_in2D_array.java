...
public class Count_of_number_of_given_string_in2D_array {
...
//Function to search the string in 2d array
	static int search(String needle, int row, int col, String str[], int row_count, int col_count) {
		int found = 0;
		int r, c;
	...
	public static void main(String[] args) {
		...
		String str[] = new String[input.length];// 6
		int i;
		for (i = 0; i < input.length; ++i) {
			str[i] = input[i];
		}
		// BBABBM - 0
		System.out.println("count: " + search(ser, 0, 0, str, str.length, str[0].length()));
	}
