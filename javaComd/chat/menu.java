...
public class menu implements ActionListener{
	...
	JTextField inUser1 ,inUser2;JButton start ,reset,close,restart;
	public menu() {
		JFrame f = new JFrame();
		...
		start.addActionListener((e)->{
			if(!inUser1.getText().equals("") && !inUser2.getText().equals("")) {
		...
		close.addActionListener((e)->{
			...
			if (in == JOptionPane.WARNING_MESSAGE) {
				System.exit(0);
			System.out.println("Chat app close");
		}});
			
		restart = new JButton("Restart");restart.setBackground(Color.green);restart.setBounds(320, 300, 90, 40);f.add(restart);
